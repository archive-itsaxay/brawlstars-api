...
class ModeSeeder extends Seeder
{
    ...
    public function run()
    {
        Mode::create(['name' => 'Boss Fight', 'slug' => 'boss_fight',
            'description' => 'Boss fight mode',
            'image' => 'boss_fight.jpg']);

        Mode::create(['name' => 'Bounty', 'slug' => 'bounty',
        ...
        Mode::create(['name' => 'Robo Rumble', 'slug' => 'robo_rumble',
            'description' => 'robo rumble description',
            'image' => 'robo_rumble.jpg']);

        Mode::create(['name' => 'Showdown', 'slug' => 'showdown',
        ...
        Mode::create(['name' => 'Smash & Gran', 'slug' => 'smash_grab',
