...
class BrawlerSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Brawler::create(['name' => 'Barley', 'slug' => 'barley',
        ...
        Brawler::create(['name' => 'Bo', 'slug' => 'bo',
        ...
        Brawler::create(['name' => 'Brock', 'slug' => 'brock',
        ...
        Brawler::create(['name' => 'Bull', 'slug' => 'bull',
        ...
        Brawler::create(['name' => 'Colt', 'slug' => 'colt',
        ...
        Brawler::create(['name' => 'Crow', 'slug' => 'crow',
        ...
        Brawler::create(['name' => 'Darryl', 'slug' => 'darryl',
        ...
        Brawler::create(['name' => 'Dynamike', 'slug' => 'dynamike',
        ...
        Brawler::create(['name' => 'El Primo', 'slug' => 'el_primo',
        ...
        Brawler::create(['name' => 'Jessie', 'slug' => 'jessie',
        ...
        Brawler::create(['name' => 'Mortis', 'slug' => 'mortis',
        ...
        Brawler::create(['name' => 'Nita', 'slug' => 'nita',
        ...
        Brawler::create(['name' => 'Pam', 'slug' => 'pam',
        ...
        Brawler::create(['name' => 'Piper', 'slug' => 'piper',
        ...
        Brawler::create(['name' => 'Poco', 'slug' => 'poco',
        ...
        Brawler::create(['name' => 'Ricochet', 'slug' => 'ricochet',
        ...
        Brawler::create(['name' => 'Shelly', 'slug' => 'shelley',
        ...
        Brawler::create(['name' => 'Spike', 'slug' => 'spike',
