...
class MapSeeder extends Seeder
{
    ...
    public function run()
    {
        new Map(['mode_id' => '4', 'name' => 'G. G. Corral', 'slug' => 'gg_corral',
            'description' => 'map',
            'image' => 'gg_corral.png']);
        new Map(['mode_id' => '4', 'name' => 'Bandit Stash', 'slug' => 'bandit_stash',
        ...
        new Map(['mode_id' => '4', 'name' => 'Kaboom Canyon', 'slug' => 'kaboom_canyon',
        ...
        new Map(['mode_id' => '4', 'name' => 'Safe Zone', 'slug' => 'safe_zone',
        ...
        new Map(['mode_id' => '6', 'name' => 'Feast Or Famine', 'slug' => 'feast_famine',
        ...
        new Map(['mode_id' => '6', 'name' => 'Skull Creek', 'slug' => 'skull_creek',
        ...
        new Map(['mode_id' => '6', 'name' => 'Death Valley', 'slug' => 'death_valley',
        ...
        new Map(['mode_id' => '6', 'name' => 'Stormy Plains', 'slug' => 'stormy_plains',
        ...
        new Map(['mode_id' => '1', 'name' => 'Calamity Canyon', 'slug' => 'calamity_canyon',
            'description' => 'map',
            'image' => 'calamity_canyon.png']);

        new Map(['mode_id' => '2', 'name' => 'Start Gulch', 'slug' => 'star_gulch',
        ...
        new Map(['mode_id' => '2', 'name' => 'Snake Prairie', 'slug' => 'snake_prairie',
        ...
        new Map(['mode_id' => '2', 'name' => 'Groundhog Burrow', 'slug' => 'groundhog_burrow',
            'description' => 'map',
            'image' => 'groundhog_burrow.png']);
        new Map(['mode_id' => '2', 'name' => 'Temple Ruins', 'slug' => 'temple_ruins',
        ...
        new Map(['mode_id' => '2', 'name' => 'Terracotta Square', 'slug' => 'terracotta_square',
            'description' => 'map',
            'image' => 'terracotta_square.png']);
        new Map(['mode_id' => '2', 'name' => 'Cabbage Patch', 'slug' => 'cabbage_patch',
        ...
        new Map(['mode_id' => '7', 'name' => 'Bone Box', 'slug' => 'bone_box',
            ...
            'image' => 'bone_box.png']);
        new Map(['mode_id' => '7', 'name' => 'Temple Catacombs', 'slug' => 'temple_catacombs',
            'description' => 'map',
            'image' => 'temple_catacombs.png']);
        new Map(['mode_id' => '7', 'name' => 'Deep Hollows', 'slug' => 'deep_hollows',
            'description' => 'map',
            'image' => 'deep_hollows.png']);
        new Map(['mode_id' => '7', 'name' => 'Hard Rock Mine', 'slug' => 'hard_rock_mine',
        ...
        new Map(['mode_id' => '7', 'name' => 'Crystal Cavern', 'slug' => 'crystal_cavern',
        ...
        new Map(['mode_id' => '7', 'name' => 'Mushroom Cave', 'slug' => 'mushroom_cave',
        ...
        new Map(['mode_id' => '3', 'name' => 'Backyard Bowl', 'slug' => 'backyard_bowl',
            'description' => 'map',
            'image' => 'backyard_bowl.png']);
        new Map(['mode_id' => '3', 'name' => 'Pinhole Punt', 'slug' => 'pinhole_punt',
            'description' => 'map',
            'image' => 'pinhole_punt.png']);
        new Map(['mode_id' => '3', 'name' => 'Triple Dribble', 'slug' => 'triple_dribble',
            'description' => 'map',
            'image' => 'triple_dribble.png']);

        new Map(['mode_id' => '5', 'name' => 'Pachinko Park', 'slug' => 'pachinko_park',
            'description' => 'map',
